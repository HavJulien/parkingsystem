...
public class DBConstants {
    ...
    public static final String GET_PARKING_SPOT_AVAILABILITY = "select AVAILABLE from parking where PARKING_NUMBER = ?";

    public static final String IS_ALREADY_CLIENT = "select ID from ticket WHERE (VEHICLE_REG_NUMBER = ?) AND (OUT_TIME IS NOT NULL) limit 1"; 
